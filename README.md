...
- Connect to container to run commands: `docker exec -it fullstack-challenge-app-1 bash`
  - Make sure you are in the `/var/www/html` path
           - * for running WSL I adjusted permissions for this version `chown -R www-data:www-data *`
  - Install php dependencies: `composer install`
  - Setup app key: `php artisan key:generate`
  - Migrate database: `php artisan migrate` 
  - Seed database: `php artisan db:seed`
  - Run Weather update manually `php artisan weather:update`
...
- Ensure nodejs v18 is active on host
            - * for running WSL I adjusted permissions for this version `sudo chown -R $(whoami) .`   
